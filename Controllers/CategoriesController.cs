...
namespace WebOS.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Image")] Category category, IFormFile myfile)
{
if (ModelState.IsValid)
{
                category.Image = await UserFile.UploadeNewImageAsync(category.Image,
myfile, _environment.WebRootPath, Properties.Resources.Images, 500, 500);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Image")] Category category, IFormFile myfile)
        {
            if (id != category.Id)
            {
                return NotFound();
